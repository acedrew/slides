...
(function( root, factory ) {
			...
			if( background.hasAttribute( 'data-loaded' ) === false ) {
				...
				// Iframes
                    ...
                    iframe.addEventListener("load", function(event) {
                        //document.querySelector('.reveal > .backgrounds').style['z-index</source>'] = 1; // set when in iframe
                    });
	...
	function startEmbeddedIframe( event ) {
		...
		if( iframe && iframe.contentWindow ) {
			...
			if( isAttachedToDOM && isVisible ) {
                ...
                document.querySelector('.reveal > .backgrounds').style['z-index'] = 1; // reset when not in iframe
	 ...
	 * should be showy, -1 means all are invisible
